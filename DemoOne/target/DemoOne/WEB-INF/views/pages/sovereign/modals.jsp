                          ...
                          <%--   <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0)" ifhref="${jpath }/Allpages/panku_manager" class="nav-link" onclick="setIf(this)">
                                    <i class="icon icon-target"></i>盘库--管理
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
                            <iframe src="" width="100%" height="1000px" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" id="newpages"></iframe>
                        </div>
                        </div>
                    </div>
                </div>
